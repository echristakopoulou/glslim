/*!
\file  
\brief It takes as input two CSR matrices and finds for each row of the first
       matrix the most similar rows in the second matrix.
...
static char simtypenames[][10] = {"", "cos", "jac", ""};
